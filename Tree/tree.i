...
# 61 "/usr/include/c++/4.8.2/queue" 2 3
...
# 62 "/usr/include/c++/4.8.2/queue" 2 3
...
# 63 "/usr/include/c++/4.8.2/queue" 2 3
...
# 126 "/usr/include/c++/4.8.2/bits/stl_queue.h" 3
    ...
    public:
      ...
      : c(__c) { }
# 149 "/usr/include/c++/4.8.2/bits/stl_queue.h" 3
      bool
      empty() const
      { return c.empty(); }
...
# 253 "/usr/include/c++/4.8.2/bits/stl_queue.h" 3
    };
...
# 430 "/usr/include/c++/4.8.2/bits/stl_queue.h" 3
      template<typename _InputIterator>
...
# 467 "/usr/include/c++/4.8.2/bits/stl_queue.h" 3
      bool
      empty() const
      { return c.empty(); }
...
# 548 "/usr/include/c++/4.8.2/bits/stl_queue.h" 3
    };
# 566 "/usr/include/c++/4.8.2/bits/stl_queue.h" 3
...
int BinaryTreeLeafSize(BTNode* root)
{
  ...
  int lNum=BinaryTreeLeafSize(root->_left);
  int rNum=BinaryTreeLeafSize(root->_right);
  return (lNum+rNum)/2;
}
int BinaryTreeLevelKSize(BTNode* root, int k)
{
  ((root!=__null) ? static_cast<void> (0) : __assert_fail ("root!=__null", "tree.cpp", 56, __PRETTY_FUNCTION__));
  queue<BTNode*> qu;
  qu.push(root);
  int level=1;
  int levNum=1;
...
{
 ((root) ? static_cast<void> (0) : __assert_fail ("root", "tree.cpp", 144, __PRETTY_FUNCTION__));
 queue<BTNode*> qu;
 qu.push(root);
 int level=1;
 while(!qu.empty())
